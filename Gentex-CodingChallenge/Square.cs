...
{
    /// <summary>
    /// Basic class implementing the geometric square object. 
    ...
    /// center:list[] -> [x coordinate, y coordinate], sidelength -> non-zero value for one of the sides of the square
    /// </summary>
    public class Square
    {
        // private variables
        ...
        public void CalculateProperties(int id, float x, float y, float sidelength)
        {
            ...
            _centroidX = x;
            _centroidY = y;
            _area = (float) sidelength * sidelength;
            _perimeter = (float)4 * sidelength;
        }
